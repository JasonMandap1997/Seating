...
const MovieScreen = () => {
    ...
    const [seatsData, setSeatsData] = useSate([]);
                ...
                <Pressable
                    ...
                    {mall.includes(item.name) ? (
                        ...
                        numColumns={3}
                         ...
                         style={{borderColor:"green", borderWidth: 0.5, width: 80, borderRadius: 7, margin: 10, padding: 5}}>
                                <Text style={{fontSize: 16, color: "green", fontWeight:"500", textAlign: "center"}}>{item}</Text>
                            </Pressable>)}
                         />
                    ) : (
                        null
